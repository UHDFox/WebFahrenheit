...
namespace Domain.Migrations
{
    ...
    [Migration("20241111100230_ChangeUserAndFeedback")]
    partial class ChangeUserAndFeedback
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Domain.Users.FeedbackRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Domain.Users.UserRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Domain.Users.FeedbackRecord", b =>
                {
                    b.HasOne("Domain.Domain.Users.UserRecord", "User")
                        .WithMany("Feedbacks")
